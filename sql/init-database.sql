-- 如果数据库不存在则创建
CREATE DATABASE IF NOT EXISTS demo5 CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
...
ON DUPLICATE KEY UPDATE czh_user_name = VALUES(czh_user_name);
...
ON DUPLICATE KEY UPDATE czh_book_name = VALUES(czh_book_name);
